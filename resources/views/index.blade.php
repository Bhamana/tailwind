...
<body>
    ...
    <section id="about" class="py-8">
        <div class="container mx-auto px-4">
            ...
            <p>Halo, saya   Bhama, seorang pelajar SMK di SMK Telkom Purwokerto dengan jurusan Rekayasa Perangkat Lunak. Saya sangat tertarik dengan pemrograman dan pengembangan web.</p>
        </div>
    </section>
    ...
    <footer class="bg-[#0a2c54] text-white py-4 text-center">
        <p>&copy; 2024 Bhama. Semua hak dilindungi.</p>
    </footer>
</body>
</html>